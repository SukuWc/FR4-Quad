...
int16_t readBits(DeviceInterface* device, uint16_t regAddr, uint8_t bitStart, uint8_t length, uint8_t *data){
    uint8_t count, b;
    if ((count = device->read(regAddr, &b, 1)) != 0) {
